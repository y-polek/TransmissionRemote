...
public class ActionBarNavigationAdapter extends BaseAdapter {
    ...
    public ActionBarNavigationAdapter(Context context) {
        ...
        textColorPrimary = ThemeUtils.resolveColor(context, android.R.attr.textColorPrimary, R.color.text_primary);
        accentColor = ThemeUtils.resolveColor(context, R.attr.colorAccent, R.color.accent);
        textColorPrimaryInverse = ThemeUtils.resolveColor(context, android.R.attr.textColorPrimaryInverse, R.color.text_primary_inverse);
    }
