...
public class TorrentStatusDbHelper extends SQLiteOpenHelper {
    ...
    public void clearServerData(SQLiteDatabase db, String serverIp) {
        db.delete(TABLE_NAME_FINISHED_STATUS, Columns.SERVER_IP + " = ?", new String[] { serverIp });
    }
